...
var predicateMatchers = [
    ...
    {matcherName : "seeAlso", predicate : "https://www.w3.org/2000/01/rdf-schema#seeAlso", abstractTemplate : "seeAlso", order : 90000},
    {matcherName : "sameAs", predicate : "https://www.w3.org/2002/07/owl#sameAs", abstractTemplate : "sameAs", order : 90000},
    {matcherName : "architecturalStyle", predicate : "http://dbpedia.org/ontology/architecturalStyle", abstractTemplate : "architecturalStyle", order : 90000},
    {matcherName : "birthPlace", predicate : "http://dbpedia.org/ontology/birthPlace", abstractTemplate : "birthPlace", order : 90000},
    {matcherName : "residence", predicate : "http://dbpedia.org/ontology/residence", abstractTemplate : "residence", order : 90000},
    {matcherName : "museum", predicate : "http://dbpedia.org/ontology/museum", abstractTemplate : "museum", order : 90000},
    {matcherName : "wikiPageRedirects", predicate : "http://dbpedia.org/ontology/wikiPageRedirects", abstractTemplate : "wikiPageRedirects", order : 90000},
    {matcherName : "deathPlace", predicate : "http://dbpedia.org/ontology/deathPlace", abstractTemplate : "deathPlace", order : 90000},
    {matcherName : "architect", predicate : "http://dbpedia.org/ontology/architect", abstractTemplate : "architect", order : 90000},
    {matcherName : "buildingEndDate", predicate : "http://dbpedia.org/ontology/buildingEndDate", abstractTemplate : "buildingEndDate", order : 90000},
    {matcherName : "buildingStartDate", predicate : "http://dbpedia.org/ontology/buildingStartDate", abstractTemplate : "buildingStartDate", order : 90000},
    {matcherName : "openingDate", predicate : "http://dbpedia.org/ontology/openingDate", abstractTemplate : "openingDate", order : 90000},
    {matcherName : "owner", predicate : "http://dbpedia.org/property/owner", abstractTemplate : "owner", order : 90000},
    {matcherName : "region", predicate : "http://dbpedia.org/property/region", abstractTemplate : "region", order : 90000},
    {matcherName : "visitors", predicate : "http://dbpedia.org/property/visitors", abstractTemplate : "visitors", order : 90000},
    {matcherName : "differentFrom", predicate : "https://www.w3.org/2002/07/owl#differentFrom", abstractTemplate : "differentFrom", order : 90000},
    {matcherName : "link", predicate : "http://dbpedia.org/property/link", abstractTemplate : "link", order : 90000},
    {matcherName : "style", predicate : "http://dbpedia.org/property/style", abstractTemplate : "style", order : 90000},
